...
class LessonTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.lesson = Lesson.objects.create(name="Тестовый урок", course_id=self.course.pk, owner=self.user)
    ...
    def test_lesson_update(self):
        ...
        self.assertEqual(
            data.get("name"), "Новый тестовый урок"
        )
...
class CourseTestCase(APITestCase):
    ...
    def test_course_update(self):
        ...
        self.assertEqual(
            data.get("name"), "Новый тестовый курс"
        )
